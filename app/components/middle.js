export default function Middle() {
  return (
    <div className=" bg-stone-300 h-full md:h-200 w-screen md:w-full text-black dark:bg-stone-900 dark:text-white ">
      <div className="relative"> <img
        src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fshape%2F5.png&w=1920&q=75"
        className=" h-20 w-20 md:h-70 md:w-70 md:m-20 "></img>
        <div className="justify-self-center absolute inset-0 text-2xl md:text-5xl font-extralight mt-10 text-red-500">-----HAPPY CUSTEMERS-----
        </div>
        <div className="justify-self-center md:absolute inset-0 text-2xl md:text-6xl font-extralight md:mt-30"> OUR CUSTOMER FEEDBACK
        </div>

      </div>
      <div className="md:grid md:grid-cols-2">
        <div className="relative">
          <div className="md:w-110 w-40 relative 4-30 md:h-100  justify-self-center overflow-hidden [clip-path:polygon(25%_0%,75%_0%,100%_50%,75%_100%,25%_100%,0%_50%)]">
            <img
          ...
          <div className="absolute inset-0">
            <img src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fteam%2F5.jpg&w=640&q=75"
              className="border-5 h-25  ml-72 md:ml-120 w-25 border-white rounded-full"></img>
            <img src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fteam%2F6.jpg&w=640&q=75"
              className="border-5 h-35 ml-70 md:ml-130 mt-0 w-35 border-white rounded-full"></img>
            <img src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fteam%2F7.jpg&w=640&q=75"
              className="border-5 h-25 ml-65 md:ml-120 mt-10 w-25 border-white rounded-full"></img>
